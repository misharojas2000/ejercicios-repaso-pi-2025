...
let edad = 22
let tieneLicencia = true
let edadQuestion = Number(readline.question("¿Cuál es su edad?"))
let licenciaQuestion = readline.question("¿Tiene licencia? (si/no): ").toLowerCase()
let puedeConducir = edadQuestion >= edad && licenciaQuestion === "si"
console.log(`¿El usuario es mayor de edad y tiene licencia? ${puedeConducir}`)
